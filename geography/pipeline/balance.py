#!/usr/bin/env python3
"""
Bank composition vs. blueprint balance checker for MS Geography.
Shows category distribution, essential standard coverage,
and suggests what to generate next.

Usage:
    python geography/pipeline/balance.py
"""
...
BLUEPRINT_PATH = os.path.join(ROOT, "blueprint", "ms_geo_blueprint.json")
