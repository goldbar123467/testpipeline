"""
Stage 1 (schema) + Stage 2 (rules) validation for ILEARN question bank.
...
def validate_rules(question: dict) -> list[str]:
    ...
    # --- Reading level (stem only; stimuli are primary-source excerpts and
    #     choices are fragments — FK inflates on both) ---
